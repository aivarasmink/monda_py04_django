...
class ProjectAdmin(admin.ModelAdmin):
    ...
    undone_tasks.short_description = _("number of undone tasks")
...
class TaskAdmin(admin.ModelAdmin):
    ...
    search_fields = ['name', 'description', 'project__name', 'owner_last_name' 'owner__username']
