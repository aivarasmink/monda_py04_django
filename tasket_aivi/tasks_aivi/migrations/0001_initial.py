# Generated by Django 5.0 on 2024-02-12 13:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='tasks_aivi.project', verbose_name='project')),
            ],
            options={
                'verbose_name': 'task',
